  ...
  return (
    <>
      ...
      <div class="w-full md:w-11/12 2xl:w-9/12 mx-auto bg-white pt-4 md:pt-12">
        <div
          class="w-11/12 md:w-9/12 lg:w-11/12 mx-auto grid grid-cols-1 
        ...
        >
          <div class="text-center md:text-center lg:text-left lg:pt-0">
            ...
            <div class="my-4 space-x-3">
              ...
              >
                <span class="mx-auto lg:mx-0 w-fit space-x-6 cursor-wait border border-cyan-600 bg-cyan-600 opacity-60 text-white h-12 items-center flex px-4 rounded">
            ...
            <div class="text-left mb-12 w-fit mx-auto lg:mx-0 flex space-x-1">
              <div class="flex -space-x-2">
                <img
                  src={user1}
                  alt="subscribers"
                  class="w-8 h-8 md:w-10 md:h-10 lg:w-10 lg:h-10 rounded-full border-2 border-white"
                />
                <img
                  src={user2}
                  alt="subscribers"
              ...
              <div class="mt-1 md:mt-2">
                Join <span class="bg-red-600 text-white p-1">1003+</span>{" "}
                Students
              </div>
            </div>
          </div>
