      ...
      <div class="w-full md:w-11/12 2xl:w-9/12 mx-auto pt-4">
        ...
        >
          <div class="text-center md:text-center lg:text-left lg:pt-0">
            ...
            <div class="mt-4 mb-0 px-1 md:px-8 lg:px-0 text-lg md:text-xl">
              ...
              <Show
                ...
                fallback={
                  <span
                    ...
                    class="mx-auto uppercase lg:mx-0 w-fit cursor-pointer bg-cyan-600 text-white p-3 md:p-4 border border-cyan-600 text-center items-center flex rounded hover:bg-white hover:text-cyan-600"
                  >
                    Sign Up/Sign In Now
                  </span>
                }
              >
                <span class="mx-auto lg:mx-0 w-fit space-x-6 cursor-wait border border-cyan-600 bg-cyan-600 opacity-60 text-white p-3 md:p-4 items-center flex rounded">
