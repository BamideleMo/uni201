              ...
              <Show
                ...
                fallback={
                  <span
                    ...
                    class="mx-auto uppercase lg:mx-0 w-fit cursor-pointer bg-cyan-600 text-white p-4 md:p-4 border border-cyan-600 text-center items-center flex px-4 rounded hover:bg-white hover:text-cyan-600"
                  >
                    Sign Up/Sign In Now
                  </span>
                }
              >
                <span class="mx-auto lg:mx-0 w-fit space-x-6 cursor-wait border border-cyan-600 bg-cyan-600 opacity-60 text-white p-4 md:p-4 items-center flex px-4 rounded">
